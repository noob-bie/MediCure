  ...
  return (
    <div className="delete-product-container">
      ...
      <div className="delete-dropdown-container">
        <div className="delete-sort-container">
          <label htmlFor="sort" className="delete-sort-label">
            Sort by:
          </label>
          <select
            id="sort"
            className="delete-sort-dropdown"
            value={sortOption}
        ...
        <div className="delete-order-container">
          <label htmlFor="order" className="delete-order-label">
            Order by:
          </label>
          <select
            id="order"
      ...
      <div className="delete-goods-container">
        <strong>Products Available for Deletion ({products.length})</strong>
      </div>

      <section className="mt-5">
        <div id="delete-goods-container">
          {products.length === 0 ? (
            ...
            products.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className={`delete-goods-card ${expired ? "expired" : ""}`}
                >
                  <img
                    src={product.image ? product.image : "default-image.jpg"}
                    alt={product.name}
                    className="delete-goods-image"
                  />
                  <div className="delete-goods-info">
                    <h3>
