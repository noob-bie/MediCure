...
const SingleProductUpdate = () => {
  ...
  // Also fix the base64 textarea handler
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      // Add unit only if it exists (for non-medicine products)
      if (editForm.unit !== undefined && editForm.unit !== null) {
        updateData.unit = editForm.unit;
      }
      ...
      if (product.category === "Medicines") {
        ...
        if (editForm.unit) updateData.unit = editForm.unit;
      }
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={(e) => {
                ...
                if (e.target.value) {
                  setPreviewImage(`data:image/jpeg;base64,${e.target.value}`);
                }
              }}
              rows={3}
              placeholder="Paste base64 encoded image here (optional)"
